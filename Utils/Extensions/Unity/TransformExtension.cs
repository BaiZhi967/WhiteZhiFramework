...
namespace WhiteZhi
{
    public static class TransformExtension
    {
        ...
        public static Transform[] FindPeers(this Transform @this, bool includeSrc = false)
        {
            ...
            if (!includeSrc)
                return Utils.Algorithm.FindAll(childTrans, t => t.parent == parentTrans && t != @this);
            else
                return Utils.Algorithm.FindAll(childTrans, t => t.parent == parentTrans);
        }
        ...
        public static T[] PeerComponets<T>(this Transform @this, bool includeSrc = false) where T : Component
        {
            ...
            Transform[] trans;
            if (!includeSrc)
                trans = Utils.Algorithm.FindAll(childTrans, t => t.parent == parentTrans);
            else
                trans = Utils.Algorithm.FindAll(childTrans, t => t.parent == parentTrans && t != @this);
